...
(function (root, factory) {
  ...
  function buyHoldScore(d, opts = {}) {
    ...
    // Tax fit / domicile (30) — PFIC risk only applies to US persons.
  ...
  function dividendScore(d, opts = {}) {
    ...
    else if (afterTax > 8 && afterTax <= 12) yPts = 34; // yields this high often aren't sustainable
    ...
    if (y > 12 && !fund) sPts = Math.min(sPts, 8); // a double-digit single-name yield rarely holds
    factors.push({
