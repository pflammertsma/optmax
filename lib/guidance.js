...
function generatePortfolioGuidance(holdings = [], cash = 0, targets = [], settings = {}, quotes = {}, watchlistData = []) {
  ...
  if (employerPct > concCritical) {
    ...
    items.push({
      ...
      message: `Your employer stock represents ${employerPct.toFixed(1)}% of your portfolio. We recommend keeping single-stock exposure under ${concLimit}% to reduce <span class="help-tooltip" style="border-bottom: 1px dotted var(--text-secondary); cursor: help;" title="The risk of putting too many eggs in one basket. If your single stock crashes, your entire portfolio suffers a major loss.">concentration risk</span>.`,
      severity: 'warning',
    });
  }
